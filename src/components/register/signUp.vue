            ...
            <div :class="{ 'fade-out': Skip ,'fade-in':!Skip}" style="z-index: 999999; position: absolute; left: 8%; top: 57%; width: 100%;">
                ...
                <div style="margin-top: 20px; margin-left: 90px; display: flex; align-items: center;">
                    <button @click="swapCircles" style="width: 117px; height: 39px;background-color: #037585;
                        border-radius: 30px; border: none; color: #ffffff; font-size: 24px; 
                        font-family: SmileySans; line-height: 23px; ">注册</button>
                    <button style="width: 60px; height: 20px;border-radius: 19.5px; border: none; background: rgba(255, 255, 255, 1);
                                font-size: 10px; font-weight: 400; letter-spacing: 0px; line-height: 12px;
                                color: rgba(147, 183, 186, 1); text-align: left; margin-left: 25px;">
                        再想想
                    </button>
                </div>
            </div>
