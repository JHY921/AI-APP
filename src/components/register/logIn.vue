<template>
    <div style="position: relative;width: 360px; height: 640px; overflow: hidden;">
        <div class="total">
            ...
            <div class="circle" :style="{
                ...
                boxShadow: '-3px 5px 30px 10px rgba(255, 255, 255, 0.7) inset, 0px 0px 5px 0px rgba(0,0,0,0.2)',
            }">
            </div>
            <div class="circle" :style="{
                position: 'absolute',
            ...
            <div :class="{ 'fade-out': Skip, 'fade-in': !Skip }"
                ...
                <div style="font-size: 18px; color: #008c99;">
                    ...
                    <input style="margin-left: 20px; background-color: #ffffff;
                        border-radius: 24px; box-shadow: 3px 4px 5px #0160752b inset;
                        height: 28px; width: 169px; border: none;" v-model="password">
                </div>
                <div style="display: flex; align-items: center; height: 30px; font-size: 12px; margin-top: 3px;
                margin-left: 90px; -webkit-transform-origin-x: 0; -webkit-transform: scale(0.90);">
                    <span style="margin-right: 10px;">是否记住密码</span>
                    <button @click="isRemember" :class="{ 'remPass': isRem }" style="width: 20px; height: 20px; border-radius: 50%; border: none;
                            box-shadow: 3px 0px 10px 0px rgba(0,0,0,0.1) inset;"></button>
                </div>
                <!-- <div style="margin-top: 20px; margin-left: 100px;"> -->
                <div style="width: 100%; margin-top: 20px;">
                    <button @click="swapCircles" style="width: 117px; height: 39px;background-color: #037585;
                ...
                <div style="position: relative; width: 100%; margin-left: 115px; margin-top: 20px;">
                    <p style="font-size: 12px;font-weight: 400;letter-spacing: 0px;
                            line-height: 14.4px;color: rgba(0, 100, 122, 0.4);vertical-align: top;
                            margin-bottom: 3px;">
                        第三方软件登录
                    </p>
                    <img src="./wechat.png" style="width: 28px; height: 28px;margin-left: 7px; margin-right: 15px;" @click="wechatLogin()">
                    <img src="./QQ.png" style="width: 28px; height: 28px;" @click="QQLogin()">
                </div>
            </div>
        </div>
    </div>
