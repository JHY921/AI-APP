<template>
    <div class="total">
        ...
        <div style="height: 568px;width: 360px;">
            <div v-for="goodsState in MyGoodsList" :key="index" style="width: 328px; height: 180px; margin: 16px; border-radius: 10px;
                    box-shadow: 0px 1px 3px  rgba(0, 0, 0, 0.1), 0px 1px 2px  rgba(0, 0, 0, 0.06);
                    background: linear-gradient(180deg, rgb(246, 246, 246) 0%, rgba(204, 204, 204, 0) 100%);
                    overflow: hidden;">
                <img :src="goodsState.img" style="width: 120px; height: 120px; border-radius: 10px; margin: 30px;
                        margin-left: 16px; margin-right: 0px;">
                <div style="display: inline-block; width: 175px; height: 150px;
                    margin-left: 16px; margin-top: 30px;
                    vertical-align: top;">
                    <p style="color: rgba(0, 94, 115, 1);font-size: 20px; font-weight: 500;">
                        {{ goodsState.name }}
                    </p>
                    <p style="font-size: 14px; font-weight: 400; color: rgba(0, 100, 122, 0.6);">
                    ...
                    <p style="font-size: 10px;font-weight: 400;color: rgba(62, 70, 71, 0.5);">
                        订单号：{{ goodsState.orderNumber }}
                    </p>
                    <div style="height: 10px;"></div><!--占位-->
                    <span v-if="goodsState.isSned" style="font-size: 16px;font-weight: 700;
                        color: rgba(0, 121, 148, 1);">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        状态：已发货
                    </span>
                    <span v-else style="font-size: 16px;font-weight: 700;
                        color: rgba(0, 121, 148, 1);">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        状态：未发货
                    </span>
