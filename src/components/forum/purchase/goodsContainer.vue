  ...
  <div class="total">
    ...
    <div
      ...
      style="
        ...
        color: #007994;
      "
      v-if="isShowSendAdvice"
    >
      <p style="font-size: 20px; font-weight: 600">
        是否确认花费{{ choosePrice }}积分购买{{ chooseGoods }}
      </p>
    ...
    <div
      class="inforContainer"
      style="margin-top: 8px; width: 360px; height: 72px"
    >
      <div
        style="
      ...
      >
        ...
        >
          ...
          >
            <img
              :src="goods.img"
              style="width: 160px; height: 156px; border-radius: 10px"
            />
          </div>
          <div
            style="
          ...
          >
            ...
            <img
              ...
              style="
                ...
                margin-top: -2px;
              "
              @click="buyGoods(goods.name, goods.price)"
            />
          </div>
        </div>
      </div>
