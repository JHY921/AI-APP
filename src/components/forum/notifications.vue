...
<div class="nav">
    <div class="nav-info">
        <img src="../../assets/info-icon/点赞.png">
        <p>收到的赞</p>
    </div>
    <div class="nav-info">
        <img src="../../assets/info-icon/评论.png">
        <p>回复我的</p>
    </div>
    <div class="nav-info">
        <img src="../../assets/info-icon/关注.png">
        <p>新的关注</p>
    </div>
    <div class="nav-info">
        <img src="../../assets/info-icon/系统通知.png">
        <p>系统通知</p>
    </div>
</div>
<div class="total-info">
    ...
    <div class="info-detail">
        ...
        <div class="detail">
            <img src="../../assets/info-icon/系统通知.png" class="system-info-icon">
...
.total-info{
    ...
    height: 576px;
    opacity: 1;
    background: linear-gradient(90deg, rgba(199, 201, 201, 0.57) 0%, rgba(255, 255, 255, 1) 100%);
}
.van-nav-bar{
    z-index:999;
    width:100%;
...
.remind-title{
    ...
    height: 24px;
    opacity: 1;
    /* background: linear-gradient(360deg, rgba(255, 255, 255, 1) 0%, rgba(0, 121, 148, 0.66) 100%); */
    background-color:rgba(255, 255, 255, 1);
    border-radius: 10px 10px 0px 0px;
    border-bottom: 0.4px solid rgba(0, 121, 148, 0.5);
}
.remind-title p{
    font-size: 12px;
    transform: scale(0.8);
