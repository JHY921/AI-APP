<template>
  <div class="total">
    ...
    <transition name="color-transition">
      <div class="course_list">
        <ul>
          ...
          >
            <div
              style="border-top-right-radius: 10px; left: -50px"
              :class="{ isMove: moveIndex === index && isClick }"
            >
              <!--:style="`position: absolute; transform: translateY(${course.total_number * 36+48}px);`"-->
              <div class="main_course" @click="mouseOver(course.course_id)">
                {{ course.course_name }}
              </div>
              <ul>
                <div class="child_course">
                  <li
                    v-for="subcategory in course.subcategories"
                  ...
                  >
                    ...
                    <center>
                      <hr
                        style="
                          width: 80px;
                          border: 0.4px solid rgba(110, 120, 122, 0.27);
                        "
                        v-if="
                          subcategory.subcategory_number != course.total_number
                        "
                      />
                    </center>
                  </li>
    ...
    <div class="course_container" style="margin-top: 10px">
      ...
      <div
        class="course_detail"
        v-for="course in courseContent.courses"
        :key="course.course_id"
