<template>
  <div class="total" style="background-color: #e7e7e7">
    <div
      class="return_label"
      style="
        margin-top: 24px;
    ...
    >
      ...
      >
        ...
        <div style="margin-left: 20px; height: 36px; text-align: center">
          <span
            style="
              margin: auto;
              line-height: 36px;
