<template>
    <div class="total">
        ...
        <div class="interactive_label">
            <div>
                <img src="./commonQuestion.png" style="width: 25px; height: 25px; vertical-align:top; margin-left: 16px;">
                <input v-model="questionInfor" style="background-image: linear-gradient(90deg, #00799496 -185.3%, #e7e8e957 100%);
                        border-radius: 16px; box-shadow: 0px 0px 10px rgba(0,0,0,0.2) inset; border: none; 
                        height: 24px; width: 246px; margin-left: 16px; font-size: 12px;" placeholder="     您遇到了什么问题">
                <img src="./sendQuestion.png" style="width: 25px; height: 25px; vertical-align:top; margin-left: 16px;" @click="Ask()">
...
.interactive_label {
    ...
    background-image: linear-gradient(180deg, #007994 -323.1%, #086a80 -157.2%, #ffffff 27%);
