<template>
    <div class="page" :style="computedheight">
        ...
        <div class="sth" :style="comH">
            ...
            <List></List>
            <List v-for="i in length" class="line-r"></List>
        </div>
        <div class="learn-time">当日累计学习时间:&ensp;<span class="highlight">{{ hour }}小时</span>
            </div>
        <div class="done">总计完成待办&ensp;<span class="highlight">{{ todo }}件</span></div>
        <div class="pg">评估状态:&ensp;<span class="highlight">{{ state }}</span></div>
        <div class="circle-1">
...
.circle-1-s{
    ...
    opacity: 1;
    border-radius: 0px 6px 6px 0px;
    background: linear-gradient(90deg, rgba(13, 109, 130, 1) 0%, 
    rgba(0, 131, 160, 1) 27.71%, rgba(106, 183, 200, 1) 60.03%, 
