    ...
    <div class="chartsConatiner">
      <div class="chartsBlock" style="margin: 0">
        ...
        <div style="display: inline-block; width: 160px; height: 200px">
          <div class="glassContainer" style="font-weight: 600;">
            当前所处阶段
            <p style="float: right;">阶段{{ levelList[userLevel] }}&nbsp;&nbsp;&nbsp;</p>
          </div>
          <div style="
              width: 140px;
              height: 45px;
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      for (var i = 0; i < 70; i++) {
        //xAxisData.push('星期' + i)
        xAxisData.push(0)
        if (i % 10 == 0) xAxisData[i] = ('星期' + day[i / 10])
        data1.push(0)
        data2.push(0)
      }//数据
      data1[0] = 4; data1[10] = 6; data1[20] = 9; data1[30] = 9; data1[40] = 17; data1[50] = 21; data1[60] = 30; data1[70] = 32;
      for (var i = 0; i < 7; i++)
        for (var j = i * 10; j < (i + 1) * 10; j++) {
          if (j % 10 != 0) data1[j] = data1[j - 1] + (data1[(i + 1) * 10] - data1[i * 10]) / 9;
        }
        data2[0] = 6; data2[10] = 9; data2[20] = 11; data2[30] = 19; data2[40] = 26; data2[50] = 30; data2[60] = 31; data2[70] = 36;
      for (var i = 0; i < 7; i++)
        for (var j = i * 10; j < (i + 1) * 10; j++) {
          if (j % 10 != 0) data2[j] = data2[j - 1] + (data2[(i + 1) * 10] - data2[i * 10]) / 9;
        }
      option = {
        grid: { // 让图表占满容器
          top: "50px",
