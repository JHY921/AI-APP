    ...
    <div class="total">
        ...
        <div class="chartsConatiner">
            <div class="chartsBlock" style="margin: 0;">
                <div id="gaugeChart" style="height: 200px; width: 200px; margin: 0px;
                ...
                <div style="display: inline-block; width: 160px; height: 200px;">
                    ...
                    <div style="width: 140px; height: 45px;
                        ...
                        background: #F0F0F0;
                        box-shadow:inset 4px 1px 2px 2px rgba(0, 0, 0, .1); border: none;
                        color: rgba(70, 138, 153, 1); line-height: 45px; text-align: center;
            ...
            <div class="chartsBlock" id="stackedLine" style="height: 186px; width: 360px;"></div>
            <div class="chartsBlock" style="height: 186px; width: 360px; border-radius: 0px;
                border-top-left-radius: 10px; border-bottom-left-radius: 10px;">
                <div id="pieChart" style="display: inline-block; height: 186px; width: 186px;
                    border-radius: 10px;"></div>
                <div style="display: inline-block; height: 186px; width: 174px;
                    border-radius: 10px; overflow: visible;">
                    <div style="height: 61px; width: 100%;
                        border-top-left-radius: 10px; border-bottom-left-radius: 10px;
                        background: linear-gradient(90deg, #74bec9 0%, #FFFFFF 100%);
                        box-shadow: 0px 0px 10px 2px rgba(0, 0, 0, 0.2);
                        color: #007791;font-size: 18px;line-height: 61px;
                        ">
                        &nbsp;&nbsp;&nbsp;&nbsp;数据分析:
                        <div style="float: right;
                            border-top-left-radius: 16px; border-bottom-left-radius: 16px;
                            width: 65px; height: 35px; background-color: #025466;
                            margin-top: 13px; line-height: 35px;
                            color: #FFFFFF;
                            text-shadow: 0 0 2px white;" @click="pieData1">
                            &nbsp;&nbsp;&nbsp;结果
                        </div>
                    </div>
                    <div style="height: 61px; width: 100%;
                        ...
                        <div style="float: right;
                            ...
                            margin-top: 13px; line-height: 35px;
                            color: #FFFFFF;
                            text-shadow: 0 0 2px white;" @click="pieData2">
                            &nbsp;&nbsp;&nbsp;结果
                        </div>
                    </div>
                    ...
                    <div style="height: 61px; width: 100%;
                        ...
                        <div style="float: right;
                            ...
                            margin-top: 13px; line-height: 35px;
                            color: #FFFFFF;
                            text-shadow: 0 0 2px white;" @click="pieData3">
                            &nbsp;&nbsp;&nbsp;结果
                        </div>
                    </div>
                </div>
            </div>
            <div class="chartsBlock" id="barChart" style="height: 210px; width: 360px;"></div>
        </div>
    </div>
</template>
...
.chartsBlock {
    position: relative;
    background: linear-gradient(180deg, rgba(255, 255, 255, 1) 80%, rgba(198, 229, 235, 0.4) 100%);
