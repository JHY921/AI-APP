<template>
    <div class="total">
        ...
        <div class="specific_item">
            <div style="width: 360px; height: 56px;font-size: 16px; text-align: left;
                vertical-align: top; line-height: 56px;">
                &nbsp;&nbsp;&nbsp;&nbsp;账号与安全
        ...
        <div style="width: 360px; height: 56px;font-size: 16px; text-align: center;
                line-height: 56px; background-color: white;
                margin-top: 20px;">
            切换账号
            <img src="./arrow.png" style="width: 12px; float: right; margin: 16px;">
        </div>
        <div style="width: 360px; height: 56px;font-size: 16px; text-align: center;
                line-height: 56px; background-color: white;
                margin-top: 20px;color: rgba(186, 0, 0, 1);">
            退出
            <img src="./arrow.png" style="width: 12px; float: right; margin: 16px;">
        </div>
    </div>
